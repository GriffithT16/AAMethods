...
function problemTwo(){
    userInput = prompt('Enter Cuisine type here')
    let results;
    results = dishes.filter(function(el){
        console.log("problemTwo's filter: ", el)
...
console.log('User selected cuisine', userChoice)
...
console.log('italianFood for 5', italianFood)
...
let idSameAsServings = problemFour();
console.log('idSameAsServings', idSameAsServings)
...
function problemTwelve(){
    ...
    let results;
    results = dishes.servings.reduce(function(el){
        console.log(" Problem Twelve ", el)
        return dishes.servings

    })
    return results
}
let addServings = problemTwelve();
console.log('servings total from problemTwelve', addServings)
